...
const TableThree = () => {
  ...
  const toggleVisibility = (buttonName) => {
    setIsHidden((prevButtonStates) => ({
      ...prevButtonStates,
              ...
              passwords.map((password, index) => (
                <tr key={index} itemID={index}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    ...
                    <a href={`https://${password.fqdn}`} target="_blank">
                      <p className="text-sm">{password.fqdn}</p>
                    </a>
                  </td>
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    <p className="text-black dark:text-white">
                    ...
                    <div className="flex items-center space-x-3.5">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <path
                              d="M17 153 c-11 -10 -8 -101 3 -108 6 -4 10 15 10 49 l0 55 58 4 57 3
-61 2 c-33 1 -64 -1 -67 -5z"
                            />
                            <path
                              d="M47 124 c-12 -12 -8 -89 5 -102 17 -17 93 -15 107 2 7 8 11 34 9 58
l-3 43 -55 3 c-31 2 -59 0 -63 -4z m103 -49 l0 -45 -45 0 -45 0 0 45 0 45 45
0 45 0 0 -45z"
                            />
                          </g>
                        </svg>
